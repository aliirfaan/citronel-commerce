...
class OrderFulfillment extends Model
{
    ...
    protected $hidden = ['created_at', 'updated_at', 'order_item_fulfillment_grp_id'];

    protected $fillable = [
        'id', 'order_item_id', 'actor_id', 'order_id', 'product_id', 'order_item_meta', 'order_item_fulfillment_status','reseller_order_reference', 'supplier_order_id', 'correlation_token', 'fulfilled_at', 'retry_count', 'result_code', 'result_message', 'previous_reseller_order_reference', 'product_code', 'order_item_fulfillment_grp_id', 'custom_value_1', 'custom_value_2', 'custom_value_3', 'custom_value_4', 'custom_value_5'
    ];
